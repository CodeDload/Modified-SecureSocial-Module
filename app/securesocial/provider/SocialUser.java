...
public class SocialUser implements java.io.Serializable {
    ...
    /**
     * A boolean indicating that the user is in the process of resetting his password (only valid if authMethod is USER_PASSWORD)
     */
    public boolean isPasswordBeingReset;
